...
struct AppConstants {
    static let metricsBaseURL = "https://golworra.com/app/metrics"
    static let salt = "HbmncyBRGNtsLG7caCT7wPHYlnJM00Yg"
    static let oneSignalAppID = "3e8ae5f8-7688-4bd6-bd8d-061dea7cbd49"
    static let userDefaultsKey = "arrow"
    static let remoteConfigStateKey = "arrowLog"
    static let userUUIDKey = "userUUID"
    static let configStrategyKey = "arrowConfigStrategy"
    
    static let remoteConfigKey = "isArrowLogEnable"
    ...
    static let appsFlyerAppID = "6754611893"
        ...
        if isEnabled {
            if let savedURL = ConfigManager.shared.getSavedURL() {
                if isTrackingPermissionResolved && isNotificationPermissionResolved {
                    ...
                    if LoaderVersion.current == .defaultLoader {
